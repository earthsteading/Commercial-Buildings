...
See National Construction Dictionary for definitions, synonymous grouping are my own:
 - [ ] HUMANS: fire dispatch centre, network utility operator, fire brigade, in-house security, fire wardens (hospital staff)
 - [ ] CLASSIFICATION: occupancy hazards (light / ordinary / high / hazardous commodities), defined by Appendix A.
 ...
 - [ ] DEVICE ACTUATORS: sprinkler heads (concealed, conventional, spray, dry pendant, dry sidewall, dry upright, extended coverage, recessed, flush, high hazard storage extra large oriface, high velocity sprayers), sprayers (medium & high velocity), nozzle extinguisher, NPSH net positive suction head --> pump design, inlet head, atmosphereic pressure, vapour pressure, alarm trigger via pressure fall, alarm valves (wet), alarm valves (dry), non-return valve,  heat sensitive sealed valves, deluge and pre-action valves, stop valves and non-return valves, pressure reducing valves, exhauster flow and fan system for ducts, tank suction piping, pumpsets (single and dual supply via AS2941), electric/fuel driven pumps, fire brigade booster assembly. Check: pink pendant, concealed activation temoerature, response time
 - [ ] SUPPORTING FIXTURES: piping, hook bolts, u-bolts, u-hangers, pipe bands, pipe support trapeze bar, threaded galzanized rod, ducts, supports, range pipes, risers, etc.  NB the fixture holding for an exposed fire hydrant main must be fire rated; pipes cannot be copper; heritage buildings might have hydrant mains outside the fire isolated stair.
 - [ ] WATER SOURCE: town mains water, on-site water mains, reticulated water supply system, rivers / lakes / damns with automatic pumpset, elevated resevoirs or gravity tank, bores via tanks and suction tank with automatic pumps, concrete / steel tanks with hydraulic componets, etc. NB Grade 1 over 25m height and NN litre capacity of tank (2x dual independent supplies of water tappings), Grade 2 (2x tappings from same supply), Grade 3 (single tapping).
 - [ ] SIGNALLING: fire brigade first goes to strobe above booster cabinet with building info, Manual Call Point (red glass box), Fire Indicator Panel in Fire Control Centre (cupboard or booster cupboard) on ground level (connected to station if sprinklers) then ASE connection to fire station, single signal to monitorring centre for control assemblies, placarding sign for control assemblies, pressure and flow switch labelled with function, voltage and current. NB if building is over 50m then FIP must be a 10m2 room which is fire protected and pressurised with desk, block planes, zones, acoustic provisions, etc.
 - [ ] MEASUERMENTS: maximum flow rate =130%, response time index (RTI), flow, residual pressure = 95% of time, metering flow prevetion calculation, effective capacity via vortex plate AS2304, suction piping AS2941, pump start controllers, hydraulic K factor, temperature rating color coding, pipe sizing diameter nominal = DN 50, chemical heat combustion data, hydrostatic pressure test MPa kPa static working pressure. duration of sprinkler head furtherest from tank ~45min, fast reponse sprinkler head temperature (60degrees and goes up from there), etc.
